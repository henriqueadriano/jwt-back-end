...
namespace JWT.Controllers
{
    ...
    public class BooksController : Controller
    {
        ...
        public IEnumerable<Book> Get()
        {
            ...
            Book[] resultBookList = getBookList();
            Book[] resultBookListAdmin = getAdminBookList();
            ...
            {
                var role = currentUser.Claims.FirstOrDefault(r => r.Type == ClaimTypes.Role).Value;
                if (role == "admin")
                { return resultBookListAdmin; }
            }
        ...
        private static Book[] getBookList()
        {
            return new Book[] {
        ...
        private static Book[] getAdminBookList()
        {
            return new Book[] {
              new Book { Author = "Ray Bradbury", Title = "Fahrenheit 451", AgeRestriction = false },
              new Book { Author = "Gabriel García Márquez", Title = "One Hundred years of Solitude", AgeRestriction = false },
